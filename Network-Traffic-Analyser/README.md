...
This project is under active development. Progress so far:
 ...
 Phase 1 — Packet capture: working Scapy-based sniffer with protocol filtering, signal handling, and timeout stop
 Phase 2 — Storage: SQLite integration; database and schema confirmed working
